        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //await AddUserWithRole(model);
                  
                    //  var userRole = new UserNews { UserString = user.Id, FirstName = model.FirstName, LastName = model.LastName };
                    //  context.UserNews.Add(userRole);
